...
ggplot(plotdata_Stim_locked_Beta, aes(x=Time, y=Stim_locked_Beta, color=Hemifield,fill=Hemifield)) + 
    ...
    coord_cartesian(ylim = c(0.6, 0.75),  xlim = c(-100, 800)) +
...
fit <- lm(RT_Asym~ PreAlphaAsym + N2c_Asym + CPPonset_Asym + CPPslope_Asym + Beta_Asym , data=participant_level)
fit <- lm(RT_Asym~ Location + Sex + Age + PreAlphaAsym + N2c_Asym + CPPonset_Asym + CPPslope_Asym + Beta_Asym , data=participant_level)
...
library(MASS)
fit <- rlm(RT_Asym~ Location + Sex + Age + PreAlphaAsym + N2c_Asym + CPPonset_Asym + CPPslope_Asym + Beta_Asym, data=participant_level)
Anova(fit) # show results
