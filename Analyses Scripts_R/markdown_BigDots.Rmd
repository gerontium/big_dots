...
library(dplyr)
data_participant_level %>% mutate(.,N2c_Asym = )
...
#First look at SLF (SLF I, II add III) - no relationship with DAT1 genotype 
...
##Between DAT1_3UTRs t-test for VOL_LI_SLF1
t.test(RT_collapsed$VOL_LI_SLF1 ~ RT_collapsed$DAT1_3UTR, na.action=na.omit)
##Between DAT1_3UTRs t-test for VOL_LI_SLF2
t.test(RT_collapsed$VOL_LI_SLF2 ~ RT_collapsed$DAT1_3UTR, na.action=na.omit)
##Between DAT1_3UTRs t-test for VOL_LI_SLF3
t.test(RT_collapsed$VOL_LI_SLF3 ~ RT_collapsed$DAT1_3UTR, na.action=na.omit)

##Between DAT1_3UTRs t-test for FA_LI_SLF1
t.test(RT_collapsed$FA_LI_SLF1 ~ RT_collapsed$DAT1_3UTR, na.action=na.omit)
##Between DAT1_3UTRs t-test for FA_LI_SLF2
t.test(RT_collapsed$FA_LI_SLF2 ~ RT_collapsed$DAT1_3UTR, na.action=na.omit)
##Between DAT1_3UTRs t-test for FA_LI_SLF3
t.test(RT_collapsed$FA_LI_SLF3 ~ RT_collapsed$DAT1_3UTR, na.action=na.omit)

##Between DAT1_3UTRs t-test for MD_LI_SLF1
t.test(RT_collapsed$MD_LI_SLF1 ~ RT_collapsed$DAT1_3UTR, na.action=na.omit)
##Between DAT1_3UTRs t-test for MD_LI_SLF2
t.test(RT_collapsed$MD_LI_SLF2 ~ RT_collapsed$DAT1_3UTR, na.action=na.omit)
##Between DAT1_3UTRs t-test for MD_LI_SLF3
t.test(RT_collapsed$MD_LI_SLF3 ~ RT_collapsed$DAT1_3UTR, na.action=na.omit)

##Between DAT1_3UTRs t-test for AD_LI_SLF1
t.test(RT_collapsed$AD_LI_SLF1 ~ RT_collapsed$DAT1_3UTR, na.action=na.omit)
##Between DAT1_3UTRs t-test for AD_LI_SLF2
t.test(RT_collapsed$AD_LI_SLF2 ~ RT_collapsed$DAT1_3UTR, na.action=na.omit)
##Between DAT1_3UTRs t-test for AD_LI_SLF3
t.test(RT_collapsed$AD_LI_SLF3 ~ RT_collapsed$DAT1_3UTR, na.action=na.omit)

##Between DAT1_3UTRs t-test for RD_LI_SLF1
t.test(RT_collapsed$RD_LI_SLF1 ~ RT_collapsed$DAT1_3UTR, na.action=na.omit)
##Between DAT1_3UTRs t-test for RD_LI_SLF2
t.test(RT_collapsed$RD_LI_SLF2 ~ RT_collapsed$DAT1_3UTR, na.action=na.omit)
##Between DAT1_3UTRs t-test for RD_LI_SLF3
t.test(RT_collapsed$RD_LI_SLF3 ~ RT_collapsed$DAT1_3UTR, na.action=na.omit)

```

#Test relationship between RT_Asym and SLF (SLF I, II add III) Asym

```{r, echo=FALSE, warning=FALSE}

##Now grab only the Asym/lateralistion index (_LI_) measures 
data_for_cor<-dplyr::select(RT_collapsed, contains("_LI_"), contains("Asym"), -contains(".Z"))

##look at r-values, p-palues, and CIs  
print(corr.test(data_for_cor, method="pearson", adjust="holm", alpha=.05,ci=TRUE),short=F)
...
corPlot(cor_matrix, numbers=T, main="Correlation betweem RT_Asymmetry & SLF_Asymmetry",  show.legend=F, upper=F,  cex = 1)
dev.off()
corPlot(cor_matrix, numbers=T, main="Correlation betweem RT_Asymmetry & SLF_Asymmetry",  show.legend=F, upper=F,  cex = 1)
...
##Make correlation matrix using ggplot:
# require(plyr)
# cor_data<-cor(data_for_cor, use = "pairwise.complete.obs",method = c("pearson"))
