...
plot(RespLockedCPPslope, resid(., scaled=TRUE) ~ Location | Sex, abline = 0)
...
##Split Participants into RT_Asym Groups (Left bias vs Right bias) and plot their N2 and CPP
...
##Split Participants into RT_Asym Quartiles and plot their N2 and CPP for the 2 most extream groups
