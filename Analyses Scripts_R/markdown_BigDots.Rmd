...
SLF<-haven::read_sav("S:/R-MNHS-SPP/Bellgrove-data/4. Dan Newman/Participant Folders_new/SLF_volumes.sav")
...
#First look at SLF (SLF I, II add III) 
...
##Between DAT1_3UTRs t-test for LI_SLF1
t.test(RT_collapsed$LI_SLF1 ~ RT_collapsed$DAT1_3UTR)
##Between DAT1_3UTRs t-test for LI_SLF2
t.test(RT_collapsed$LI_SLF2 ~ RT_collapsed$DAT1_3UTR)
##Between DAT1_3UTRs t-test for LI_SLF3
t.test(RT_collapsed$LI_SLF3 ~ RT_collapsed$DAT1_3UTR)



##Look for correlation between RT-asym and SLF-asym
dplyr::select(RT_collapsed, RT_Asym, LI_SLF1, LI_SLF2, LI_SLF3)

cor(dplyr::select(RT_collapsed, RT_Asym, LI_SLF1, LI_SLF2, LI_SLF3), use = "pairwise.complete.obs",
    method = c("pearson"))


cor_matrix<-cor(as.matrix(dplyr::select(RT_collapsed, RT_Asym, LI_SLF1, LI_SLF2, LI_SLF3)), use="na.or.complete")
...
#First Look at the effect of Hemifield on RT, regardless of DAT1 genotype 
```{r, echo=FALSE, warning=FALSE}
